...
st.write("Esta aplicacion permite obtener datos de una API y almacenarlos en un base de datos SQL")
...
if menu == "Inicio":
    ...
    st.write("Esta aplicacion permite obtener datos de una API y almacenarlos en una base de datos SQL")
